...
with open('trace_data/delay_traces.txt') as f0:
 	v0 = NP.loadtxt(f0, delimiter=",", dtype='int', comments="#", skiprows=0, usecols=None)
...
ax0.set_title('Sampled MRd-CPlD latency distribution')
...
n, bins, patches = ax0.hist(v0_hist, bins = range(0,15000,10), facecolor='green')
